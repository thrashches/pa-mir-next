...
export default function Advantages() {
    const advantages: Array<{
        ...
        {
            title: "Опыт",
            text: "Работаем с 2006 года. За это время сформирована и сохранена профессиональная команда переводчиков."
        },
        {
            title: "Качество",
            text: "Обеспечиваем качественный перевод при скорости 500 страниц в неделю и более"
        },
        {
            title: "Сроки",
